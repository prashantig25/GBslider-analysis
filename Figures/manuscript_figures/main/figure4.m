...
% INITIALISE VARS
betas_subjs = importdata(fullfile("Data",filesep,"LR analyses",filesep,"betas_signed_wo_rewunc_obj.mat")); % participant betas
betas_agent = importdata(fullfile("Data",filesep,"LR analyses",filesep,"agent",filesep,"betas_agent_recoding_wo_rewunc.mat")); % agent betas
p_vals = importdata(fullfile("Data",filesep,"LR analyses",filesep,"p_vals_signed_wo_rewunc_obj.mat")); % p-vals from ttest
data_subjs = readtable(fullfile("Data",filesep,"LR analyses",filesep,"preprocessed_data.xlsx")); % participant lr data
...
print(fig, fullfile(save_dir,filesep,'learning2.png'), '-dpng', '-r600') 