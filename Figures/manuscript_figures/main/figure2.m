...
all_strings = {'Left   Right','Left    Right','\mu = 0.9','\mu = 0.9','0.9      0.1','0.1      0.9'};
num_strings = 6;
...
x = 1:25; % x-axis
hold on
lg_curves(x,mean_curves./100,sem_curves./100,colors_name,legend_names,title_name, ...
    xlabelname,ylabelname,font_size,linewidth_box,font_name)
xlim([1,25])
...
image_png = {'highcon_patch.png','lowcon_patch.png','lowcon_patch.png','highcon_patch.png'};
num_pngs = 4;
for n = 1:num_pngs
