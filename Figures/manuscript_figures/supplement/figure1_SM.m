% figure1_SM creates figure S1 and plots the results from the analysis 
% of absolute LRs
...
save_figures = fullfile(desiredPath, filesep, "stats_saved",filesep,"figures"); % path to save stats for this figure
mkdir(save_figures)
...
safe_saveall(strcat(save_figures,filesep,'figure1_SM.csv'),save_table);
