...
lr_analysis.get_rew_mu(); % compute required variables for PE and UP
...
% EXCLUDE TRIALS
lr_analysis.remove_conditions(); % remove conditions
lr_analysis.remove_zero_pe(); % remove trials with PE = 0
