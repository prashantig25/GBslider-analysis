...
% import parameters
params_basicRL = importdata("params_basicRL_sigma_NointegratedPerceptual.mat");
params_RLsigma = importdata("params_RLsigma_NointegratedPerceptual.mat");
params_RLsigma_confirmBias = importdata("params_RLsigma_confirmBias_NointegratedPerceptual.mat");
params_bayesianAgent = importdata("params_bayesianAgent_NointegratedPerceptual.mat");
params_bayesianAgent_confirmBias = importdata("params_bayesianAgent_confirmBias_NointegratedPerceptual.mat");

% import task-related data
data = importdata("preprocessed_dataFitting.mat");
uniqueID = unique(data.ID);
data = data(data.choice_cond ~= 3,:);
data = data(data.choice_cond ~= 1,:);
...
legend({'','Basic RL','','','RL Sigma','','','','RL Sigma + CB','','','','Bayesian agent','','','','Bayesian agent + CB'})%% PLOT PE vs. UP
