...
% import parameters
params_basicRL = importdata("params_basicRL_sigma_NointegratedBoth.mat");
params_RLsigma = importdata("params_RLsigma_NointegratedBoth.mat");
params_RLsigma_confirmBias = importdata("params_RLsigma_confirmBias_NointegratedBoth.mat");
params_bayesianAgent = importdata("params_bayesianAgent_NointegratedBoth.mat");
params_bayesianAgent_confirmBias = importdata("params_bayesianAgent_confirmBias_NointegratedBoth.mat");
...
nSimulations = 20;  % Number of simulations per model/subject
...
for m = 1:numModels
    for n = 1:numSubjs
        ...
        for ns = 1:nSimulations
            ...
            uni_perc = unique(dataSubj.blocks(dataSubj.choice_cond==1)); % block number for condition = 2
            ...
            for b = 1:num_blocks
                ...
                temp_perc = dataSubj.mu_basicRL(and(dataSubj.blocks == uni_perc(b), dataSubj.choice_cond == 1));
                    
                % eeTemp_mix = dataSubj.estError(and(dataSubj.blocks == uni_mix(b), dataSubj.choice_cond == 1));
                eeTemp_perc = dataSubj.estError(and(dataSubj.blocks == uni_perc(b), dataSubj.choice_cond == 1));
