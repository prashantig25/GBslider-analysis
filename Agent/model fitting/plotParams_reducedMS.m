...
% fitReducedModelSpace.m saves its output, regardless of MATLAB's current
% folder.
currentDir = cd;
...
% Filenames match fitReducedModelSpace.m's multi-start (multiSP) outputs.
plot_fitted_params('Both', ...
    fullfile(save_dir, 'params_basicRL_RBVoi_Both_multiSP.mat'), ...
    fullfile(save_dir, 'params_RLSigma_RBVoi_Both_multiSP.mat'), ...
    fullfile(save_dir, 'params_bayesianAgent_integratedBoth_multiSP.mat'), ...
    fullfile(save_dir, 'AICBIC_integratedBoth_reducedMS_multiSP.mat'));

plot_fitted_params('Perceptual', ...
    fullfile(save_dir, 'params_basicRL_RBVoi_Perceptual_multiSP.mat'), ...
    fullfile(save_dir, 'params_RLSigma_RBVoi_Perceptual_multiSP.mat'), ...
    fullfile(save_dir, 'params_bayesianAgent_integratedPerceptual_multiSP.mat'), ...
    fullfile(save_dir, 'AICBIC_integratedPerceptual_reducedMS_multiSP.mat'));
